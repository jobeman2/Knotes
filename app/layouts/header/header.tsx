...
import { Search, Pin, Download, MoreHorizontal, Menu } from "lucide-react";
...
const Header = () => {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-4 lg:px-8 bg-background/80 backdrop-blur-md sticky top-0 z-30 font-dm-sans transition-colors border-b border-border">
      ...
      <div className="flex items-center gap-4 flex-1">
        ...
        <div className="flex-1 flex justify-center max-w-xl mx-auto lg:mx-0">
      ...
      {/* Metadata / Actions (Hidden on mobile to save space) */}
      <div className="flex items-center gap-6">
        <div className="hidden sm:flex items-center gap-4 border-r border-border pr-6">
        ...
        <div className="flex items-center gap-3 lg:gap-6">
          <div className="flex items-center gap-3 lg:gap-4">
            ...
            <Link
              href="/register"
              className="hidden lg:block text-sm font-bold text-muted-foreground uppercase tracking-wider hover:text-foreground transition-colors"
            >
              Register
            </Link>
          </div>
          ...
          <div className="flex -space-x-2">
            ...
            <button className="hidden sm:flex w-8 h-8 rounded-full border-2 border-surface bg-muted items-center justify-center text-muted-foreground hover:text-foreground transition-colors ring-1 ring-border">
